...
const Card: React.FC<CardProps> = ({ name, index, address, img }) => {
  ...
  return (
    ...
    <div className="card_container">
      <div className="card_container_img" onClick={handleClick}>
        {img ? <img src={img} alt="Card Image" /> : <img src={img1} alt="Default Image" />}
      </div>
      <div className="card_container_body">
        ...
        <div className="card_container_body_lower">
          {/* <div>{address}</div> */}
          <p className="card_container_body_lower_add" onClick={copyToClipboard}>
            0x2b...6D5cbF{" "}
            <svg
